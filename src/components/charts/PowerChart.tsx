...
export default function PowerChart() {
  ...
  const currentVal = windowData.length > 0 ? windowData[windowData.length - 1].power : 0;
    ...
    <div className="glass-panel rounded-xl p-5">
      <div className="mb-4 flex items-center justify-between">
        <div>
          ...
          <h3 className="text-sm font-bold text-white">Real-Time Pack Power</h3>
        </div>
